...
\begin{thebibliography}{9}
  ...
  \bibitem{shifts} N. Ollinger. \emph{Two-by-two Substitution Systems and the Undecidability of the Domino Problem}. 2008. hal-00204625v1.
  
  \bibitem{dom_prob} E. Jeandel \& P. Vannier. The Undecidability of the Domino Problem, \emph{in} \emph{Substitution and Tiling Dynamics: Introduction to Self-inducing Structures}, LNM volume 2273. Springer, 2020

  \bibitem{compl} F. Schwarzentruber. \emph{The Complexity of Tiling Problems}. 2019. arXiv:1907.00102v2.

  \bibitem{algo} Emmanuel Jeandel \& Michaël Rao \emph{An aperiodic set of 11 Wang tiles}. 2021. arXiv:1506.06492.
\end{thebibliography}
